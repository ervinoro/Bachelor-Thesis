...
\begin{table}[h]
	...
	\begin{threeparttable}
		...
		\begin{tabular}{r|l|l}
			...
			\end{tabular} \\
			\hline
			2~B & Function ID & uint16 \\
			\hline
			1~B & Version no & uint8 \\
			\hline
			2~B & Length of body & uint16 \\
			\hline
			2~B & \Gls{sram} offset (global variables only) & uint16 \\
		\end{tabular}
		\begin{tablenotes}
			\small

...
In case of issues with the satellite, it might be necessary to boot the \gls{obc} without external devices. This means that at least critical software components must be stored in the internal flash.
